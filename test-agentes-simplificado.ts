#!/usr/bin/env tsx
/**
 * TESTE SIMPLIFICADO - AGENTES FUNCIONANDO
 * Execute com: npx tsx test-agentes-simplificado.ts
 * 
 * Testa apenas os agentes que estão funcionando:
...
- Tratar parasitas (Otodectes cynotis)`.trim(),
};
...
// ==================== EXECUÇÃO PRINCIPAL ====================
async function executarTesteAgente(agente: 'deepseek' | 'kimi') {
  console.log(`
╔═══════════════════════════════════════════════════════════════╗
...
╚═══════════════════════════════════════════════════════════════╝
  ...
  console.log('\n📝 Observações:');
  console.log('   • Google Gemini foi pulado devido à chave API incompleta');
  console.log('   • Para corrigir: GEMINI_API_KEY precisa ser completa no .env.local');
  console.log('   • DeepSeek e Kimi estão funcionando corretamente');
}
