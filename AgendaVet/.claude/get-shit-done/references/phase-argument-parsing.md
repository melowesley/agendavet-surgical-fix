...
```bash
PHASE_INFO=$(node "C:/Users/Computador/AgendaVet-Surgical-Fix/AgendaVet/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "C:/Users/Computador/AgendaVet-Surgical-Fix/AgendaVet/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "C:/Users/Computador/AgendaVet-Surgical-Fix/AgendaVet/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
