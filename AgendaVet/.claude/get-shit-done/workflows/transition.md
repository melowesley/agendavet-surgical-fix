...
```bash
TRANSITION=$(node "C:/Users/Computador/AgendaVet-Surgical-Fix/AgendaVet/.claude/get-shit-done/bin/gsd-tools.cjs" phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node "C:/Users/Computador/AgendaVet-Surgical-Fix/AgendaVet/.claude/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
node "C:/Users/Computador/AgendaVet-Surgical-Fix/AgendaVet/.claude/get-shit-done/bin/gsd-tools.cjs" config-set workflow._auto_chain_active false
```
