...
- Usage: Reference from command with `@C:/Users/Computador/AgendaVet-Surgical-Fix/AgendaVet/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Users/Computador/AgendaVet-Surgical-Fix/AgendaVet/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/Computador/AgendaVet-Surgical-Fix/AgendaVet/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
